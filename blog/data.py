SLIDER_POSTS = [
    ...
    },
    {
        ...
        "image": "img/blog/blog-slider/image_the-biggest-mistake-ever.jpg",
        "date": "3 days ago",
    ...
    {
        "title": "An Open Letter to Bureaucrats (A Must-Read)",
        "image": "img/blog/blog-slider/image_an-open-letter-to-bureaucrats.jpg",
        "date": "2 days ago",
...
BLOG_POSTS = [
    {
        ...
        "content": "Лиза и Оля всегда неровно дышали к программированию. Они решили создать команду: Лиза будет изучать Python, а Оля — вёрстку. В конце получится веб-студия, способная с нуля сделать любой заказ ...",
        "author": "Admin",
        "comments_count": 2,
